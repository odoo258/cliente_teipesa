...
#         income_acc = accounts['income'].id
#         cost_tot = discount_tot = 0.0
...
#         if discount_tot:
#             move_line_disc_tot = {}
#             move_line_disc_tot['account_id'] = income_acc
#             move_line_disc_tot['price_unit'] = self.currency_id.compute(discount_tot, self.env.user.company_id.currency_id)
#             move_line_disc_tot['quantity'] = i_line.quantity
#             move_line_disc_tot['price'] = self.currency_id.compute(discount_tot, self.env.user.company_id.currency_id)
