...
******************************************************** */
    chrome.OrderSelectorWidget.include({
        ...
        neworder_click_handler: function(event, $el) {
            if ($.inArray(this.pos.config.group_multi_order_id[0], this.pos.user.groups_id) == -1) {
        ...
        deleteorder_click_handler: function(event, $el) {
            if ($.inArray(this.pos.config.group_delete_order_id[0], this.pos.user.groups_id) == -1) {
                this.gui.show_popup('error',{
...
******************************************************** */
    screens.NumpadWidget.include({
        ...
        clickSwitchSign: function() {
            if ($.inArray(this.pos.config.group_negative_qty_id[0], this.pos.user.groups_id) == -1) {
                this.gui.show_popup('error',{
        ...
        clickChangeMode: function(event) {
            if (event.currentTarget.attributes['data-mode'].nodeValue == 'discount' &&
                    ($.inArray(this.pos.config.group_discount_id[0], this.pos.user.groups_id) == -1)) {
                this.gui.show_popup('error',{
                    ...
                    ($.inArray(this.pos.config.group_change_unit_price_id[0], this.pos.user.groups_id) == -1)) {
                this.gui.show_popup('error',{
